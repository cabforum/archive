...
Effective June 31, 2019, the CA SHALL confirm that prior to issuance the CA has validated every IP Address listed in the Certificate using at least one method specified in this section 3.2.2.5.
